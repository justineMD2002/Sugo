...
import type { DashboardChartData } from "@/lib/api/dashboard"
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Orders and service requests over time
          </span>
        ...
        >
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillServiceRequests" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-serviceRequests)"
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
